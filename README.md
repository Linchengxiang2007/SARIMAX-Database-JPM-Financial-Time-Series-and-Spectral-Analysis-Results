...
## Contents
- `JPM_data.csv`: Daily historical prices for J.P. Morgan.
- `spectral_results/`: Magnitudes and periods for detected cyclical waves.
- `hyperparameters.json`: Optimized SARIMAX parameters used in the study.
